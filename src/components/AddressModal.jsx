...
import markerIcon from "../public/logo.png";
...
const AddressModal = ({
  ...
  const handleButtonClick = () => {
    setSelectedAddress(
      address.find((address) => address.customeraddressid === selectedAddressID)
    );
                    ...
                    <div className="order-address-body flex flex-col space-y-1 border border-gray-200 rounded-lg p-4 hover:border-blue-500 hover:shadow-md cursor-pointer w-full">
                      <label className="flex items-center space-x-2">
                        <input
                          ...
                          checked={
                            selectedAddressID === address.customeraddressid
                        ...
                        <div>
                          <div className="flex flex-row justify-between items-center space-x-2">
                            ...
                            {address.customerAddressDefault === true ? (
                          ...
                          <div className="flex flex-row justify-between items-center space-x-2">
                            <p className="text-sm text-gray-500">
                              ...
                              {address.customerbarangay}, {address.customercity}
                            </p>
