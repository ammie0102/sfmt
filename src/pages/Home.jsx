        ...
        <section id="about">
            ...
            <div className="flex container gap-5 justify-center">
              ...
              >
                ...
                <p className="font-normal text-gray-700 dark:text-gray-400">
                  Santa Fe Taguktukan is a small food business with 5 branch
                  over Batangas City. Founded in June 2020, our company has
                  grown from a small local business to a thriving company with
                  over 10 employees. We started out offering just a few products
                  but have expanded our catalog over the years to serve
                  customers.
                </p>
              </a>
              <a
              ...
              >
                ...
                <p className="font-normal text-gray-700 dark:text-gray-400">
                  ...
                  development. Led by our founder Mrs. Elena Gonda who has over
                  3 years in the industry, our close-knit staff works together
                  like a family to offer specialized products and attentive
                  service. With diverse backgrounds and skills, our small but
                  mighty team strives to help customers in our local community.
                </p>
              </a>
            </div>
          </div>
          ...
          <div className="flex gap-5 justify-center pb-5  ">
            ...
            >
              ...
              <p className="font-normal text-gray-700 dark:text-gray-400">
                To Become the prominent "Lechonan" Business that provides
                quality products such as Lechon Manok, Liempo and its unique
                Chicken Sisig and Liempo Sisig
              </p>
            </a>
            <a
              href="#"
            ...
            >
              ...
              <p className="font-normal text-gray-700 dark:text-gray-400">
                ...
                maintaining customer's satisfaction by providing quality
                products. The company aims well to undertake fir new development
                and product innovation to respond customer's needs and wants.
              </p>
            </a>
            <a
              href="#"
